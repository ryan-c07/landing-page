...
const Navbar = () => {
  ...
  return (
    <motion.header
      ...
      initial="hidden"
      animate="show"
      className="sticky top-0 z-50 bg-black/50 backdrop-blur-sm border-b border-yellow-500/20"
    >
        ...
        <div className="flex justify-between h-16 items-center">
          ...
          >
            <Link href="/" className="flex items-center space-x-2">
              ...
              <span className="font-bold text-xl text-yellow-500">Ryan Chen</span>
            </Link>
          </motion.div>
          ...
          {/* Mobile Menu Button */}
          <motion.button
            className="sm:hidden p-2 text-white hover:text-yellow-500"
